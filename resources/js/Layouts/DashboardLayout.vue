...
<template>
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        <div class="flex">
            <!-- Sidebar -->
            <aside
                class="w-64 min-h-screen flex flex-col justify-between bg-white border-r border-gray-200 shadow-sm"
            >
                <div>
                    ...
                    <nav class="px-3 py-4 space-y-1">
                        ...
                        <Link
                            ...
                            :class="linkClass('/admin/manufacturing')"
                        >
                            <svg
                                class="w-5 h-5"
                                fill="none"
                        ...
                        <button
                            ...
                            :class="isDownloadingReport ? 'opacity-35' : ''"
                            class="bg-blue-100 mt-4 border border-blue-400 cursor-pointer disabled:cursor-not-allowed text-blue-700 font-semibold hover:bg-blue-200 hover:border-blue-500 flex items-center gap-3 px-3 py-2.5 text-sm rounded-lg transition-all w-full"
                        >
                            <svg
                ...
                <div class="px-3 pb-4 border-t border-gray-200 pt-4">
                    <Link
                        ...
                        method="post"
                        as="button"
                        class="flex w-full cursor-pointer items-center gap-3 px-3 py-2.5 text-sm font-medium text-red-700 rounded-lg hover:bg-red-50 transition-all"
                    >
                        <svg
                            class="w-5 h-5"
                            fill="none"
