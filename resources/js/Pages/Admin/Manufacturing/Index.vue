    ...
    <DashboardLayout>
        ...
        <template #default>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div
                    v-if="success && success.length > 0"
                    class="rounded-lg bg-green-50 border border-green-200 p-4 mt-6"
                >
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-green-800">
                                Fabricación registrada con éxito
                            </h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-red-800">
                                Error al registrar la fabricación
                            </h3>
